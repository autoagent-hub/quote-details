...
export const DEFAULT_PACKAGES: ServiceItem[] = [
  {
    ...
    sub: "Exterior hand wash, wheels, towel dry",
    price: 60,
    enabled: true,
  },
  {
    ...
    sub: "Vacuum, wipe-down, glass, mats",
    price: 120,
    enabled: true,
  },
  {
  ...
  },
  {
    key: "full_detail",
    label: "Full Detail",
    sub: "Inside and out, top to bottom",
    price: 190,
    enabled: true,
  },
  {
    ...
    sub: "Full detail plus 1-step polish",
    price: 320,
    enabled: true,
  },
  {
    ...
    sub: "For regular monthly clients",
    price: 85,
    enabled: false,
  },
];
...
export const DEFAULT_SERVICES: ServiceItem[] = [
  {
    ...
    sub: "Heavy shedding, embedded fur",
    price: 40,
    enabled: true,
  },
  {
  ...
  },
  {
    ...
    sub: "9H gloss, 2-year protection",
    price: 250,
    enabled: true,
  },
  {
    key: "interior_shampoo",
    label: "Interior Shampoo & Extraction",
    sub: "Deep-clean carpets and seats",
    price: 90,
    enabled: true,
  },
  {
    key: "leather",
    label: "Leather Clean & Condition",
    sub: "Feed and protect leather trim",
    price: 50,
    enabled: true,
  },
  {
  ...
  },
  {
    ...
    sub: "Degrease and dress the bay",
    price: 45,
    enabled: true,
  },
  {
    ...
    sub: "Pull embedded paint grit",
    price: 70,
    enabled: true,
  },
  {
    key: "wax",
    label: "Wax & Paint Sealant",
    sub: "3-month gloss protection",
    price: 60,
    enabled: true,
  },
  {
  ...
  },
  {
    ...
    sub: "Clear up yellowed lenses",
    price: 60,
    enabled: true,
  },
  {
    key: "wheels",
    label: "Wheel & Wheel-Well Deep Clean",
    sub: "Iron fallout and brake dust",
    price: 45,
    enabled: true,
  },
  {
    key: "tire_shine",
    label: "Tire Shine",
    sub: "Satin non-sling dressing",
    price: 15,
    enabled: true,
  },
  {
    key: "glass",
    label: "Glass Polish & Water Repellent",
    sub: "Streak-free, rain-beading",
    price: 35,
    enabled: true,
  },
  {
    key: "trim",
    label: "Plastic Trim Restoration",
    sub: "Re-black faded exterior trim",
    price: 40,
    enabled: true,
  },
  {
    key: "bug_tar",
    label: "Bug & Tar Removal",
    sub: "Front end and rockers",
    price: 30,
    enabled: true,
  },
  {
    key: "undercarriage",
    label: "Undercarriage / Salt Wash",
    sub: "Winter road salt flush",
    price: 30,
    enabled: false,
  },
  {
    key: "headliner",
    label: "Headliner Spot Clean",
    sub: "Careful low-moisture clean",
    price: 45,
    enabled: false,
  },
];
